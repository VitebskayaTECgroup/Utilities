...
namespace Logger_Installer
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Text = "C:\\Services\\Logger";
			// 
			// label2
			// 
			...
			this.textBox2.Text = "Data Source=VOID\\SQLEXPRESS; Initial Catalog=LoggerTest; Persist Security Info=Tr" +
    "ue; User ID=logger; Password=logger;";
			this.textBox2.TextChanged += new System.EventHandler(this.textBox2_TextChanged);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(664, 89);
			...
			this.button3.Text = "Запуск установки";
			...
			this.richTextBox1.Size = new System.Drawing.Size(764, 266);
